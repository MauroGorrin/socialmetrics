...
Tokens in `src/styles/globals.css`. Components reference token names only.

| Role | Value |
|---|---|
| Primary | `#0F172A` (light), `#E0E7FF` (dark) |
...
- **Type:** Inter 400–700 · body 16px/1.5 · mono 14px
- **Spacing:** 4px base (4, 8, 12, 16, 24, 32, 48, 64)
- **Radius:** 4px buttons, 8px cards, full avatars
- **Motion:** 150ms enter, 300ms exit; opacity + scale only
